...
class FacilitiesDetail extends Component {
    ...
    componentDidMount() {
        ...
        // fetch(`http://dev.uprm.edu/dsca/v1/api/facilities/${id}`).then(response => {
        fetch(`http://dev.uprm.edu/dsca/v1/api/facilities/${id}`).then(response => {
            response.json().then(data => {
                ...
                // fetch(`http://dev.uprm.edu/dsca/v1/api/activityByFacility/${id}`).then(response => {
                fetch(`http://dev.uprm.edu/dsca/v1/api/activityByFacility/${id}`).then(response => {
                    response.json().then(data => {
                ...
                // fetch(`http://dev.uprm.edu/dsca/v1/api/facilities/managers/${id}`).then(response => {
                fetch(`http://dev.uprm.edu/dsca/v1/api/facilities/managers/${id}`).then(response => {
                    response.json().then(data => {
    ...
    addManager = () => {
        ...
        fetch(`http://dev.uprm.edu/dsca/v1/api/facilities/${facilitiesId}/addManager/${managerId}`, {
            method: 'POST',
            ...
            if (response.ok) {
                ...
                response.json().then(newMembership => {
                    ...
                    fetch(`http://dev.uprm.edu/dsca/v1/api/facilities/managers/${facilitiesId}`).then(response => {
                        response.json().then(data => {
                            this.setState({facilitiesManagers: data});
    ...
    removeManager = (managerId) => {
        ...
        fetch(`http://dev.uprm.edu/dsca/v1/api/facilities/managers/${this.state.facilitiesId}/${managerId}`, {
            method: 'DELETE',
            headers: {'Content-Type': 'application/json'},
        }).then(response => {
            if (response.ok) {
                response.json().then(removedManager => {
                    ...
                    fetch(`http://dev.uprm.edu/dsca/v1/api/facilities/managers/${this.state.facilitiesId}`).then(response => {
                        response.json().then(data => {
                            this.setState({facilitiesManagers: data});
    ...
    onSubmit = (event) => {
        ...
        fetch(`http://dev.uprm.edu/dsca/v1/api/facilities/${this.state.facilitiesId}`, {
            method: 'PUT',
            headers: {'Content-Type': 'application/json'},
