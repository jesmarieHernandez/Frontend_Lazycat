...
class OrganizationDetail extends Component {
    ...
    componentDidMount() {
        ...
        // fetch(`http://dev.uprm.edu/dsca/v1/api/organizations/${id}`).then(response => {
        ...
        fetch(`http://dev.uprm.edu/dsca/v1/api/organizations/${id}`).then(response => {
            response.json().then(data => {
                ...
                console.log(`http://dev.uprm.edu/dsca/v1/api/organizations/${id}`);
                console.log(data);
                ...
                // fetch(`http://dev.uprm.edu/dsca/v1/api/activityByOrg/${id}`).then(response => {
                fetch(`http://dev.uprm.edu/dsca/v1/api/activityByOrg/${id}`).then(response => {
                    response.json().then(data => {
                ...
                // fetch(`http://dev.uprm.edu/dsca/v1/api/organizations/counselors/${id}`).then(response => {
                fetch(`http://dev.uprm.edu/dsca/v1/api/organizations/counselors/${id}`).then(response => {
                    response.json().then(data => {
                ...
                // fetch(`http://dev.uprm.edu/dsca/v1/api/organizations/members/${id}`).then(response => {
                fetch(`http://dev.uprm.edu/dsca/v1/api/organizations/members/${id}`).then(response => {
                    response.json().then(data => {
        ...
        // fetch('http://dev.uprm.edu/dsca/v1/api/organization_types').then(response => {
        fetch('http://dev.uprm.edu/dsca/v1/api/organization_roles').then(response => {
            if (response.ok) {
                response.json().then(results => {
                    console.log("Organization Types");
                    console.log(results);
    ...
    removeMember = (memberId) => {
        ...
        fetch(`http://dev.uprm.edu/dsca/v1/api/organizations/members/delete/${memberId}/${this.state.orgId}`, {
            method: 'DELETE',
            ...
            if (response.ok) {
                ...
                response.json().then(createdOrganization => {
                    ...
                    fetch(`http://dev.uprm.edu/dsca/v1/api/organizations/members/${this.state.orgId}`).then(response => {
                        response.json().then(data => {
                            this.setState({organizationMembers: data});
    ...
    removeCounselor = (counselorId) => {
        ...
        fetch(`http://dev.uprm.edu/dsca/v1/api/organizations/counselors/delete/${counselorId}/${this.state.orgId}`, {
            method: 'DELETE',
            headers: {'Content-Type': 'application/json'},
        }).then(response => {
            if (response.ok) {
                ...
                response.json().then(createdOrganization => {
                    ...
                    // this.props.history.push(`/admin/organizations/`);
                    // this.props.history.push(`/admin/organizations/${createdOrganization._id}`);
                    fetch(`http://dev.uprm.edu/dsca/v1/api/organizations/counselors/${this.state.orgId}`).then(response => {
                        response.json().then(data => {
                            this.setState({organizationCounselors: data});
    ...
    addCounselor = () => {
        ...
        fetch(`http://dev.uprm.edu/dsca/v1/api/organizations/${organizationId}/addCounselor/${counselorId}`, {
            method: 'POST',
            headers: {'Content-Type': 'application/json'}
        }).then(response => {
            if (response.ok) {
    ...
    addMember = () => {
        ...
        fetch(`http://dev.uprm.edu/dsca/v1/api/organizations/${organizationId}/addMember/${studentId}/role/${studentRole}`, {
            method: 'POST',
            headers: {'Content-Type': 'application/json'}
        }).then(response => {
            if (response.ok) {
    ...
    onSubmit = (event) => {
        ...
        fetch(`http://dev.uprm.edu/dsca/v1/api/organizations/${this.state.orgId}`, {
            method: 'PUT',
            headers: {'Content-Type': 'application/json'},
